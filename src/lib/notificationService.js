...
const ACTION_TEXT_MAP = {
  ...
  content_map_submitted:           'submitted a content map for review',
  content_map_comment_added:       'commented on a content map',
  content_map_client_approved:     'approved the content map',
  content_map_changes_requested:   'requested content map changes',
  content_map_node_published:      'published a mapped page',
  content_map_site_drift:          'found site changes to review',
  content_map_node_overdue:        'flagged an overdue content node',
